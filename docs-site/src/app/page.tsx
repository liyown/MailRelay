...
function Install() { return <div className="install"><div className="install-tabs"><span className="active">Go</span><span>macOS</span><span>Linux</span></div><div className="install-command"><span>$</span><code>go install github.com/liyown/MailRelay/cmd/mailrelay@latest</code></div></div>; }
